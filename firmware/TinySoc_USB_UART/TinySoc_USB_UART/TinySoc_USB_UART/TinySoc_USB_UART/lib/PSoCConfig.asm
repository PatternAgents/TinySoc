...
export LoadConfig_USB_Radon_Tiny
export _LoadConfig_USB_Radon_Tiny
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_USB_Radon_Tiny
	lcall	LoadConfigTBL_USB_Radon_Tiny_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration USB_Radon_Tiny
;
;    Load configuration registers for USB_Radon_Tiny.
...
;               CUR_PP
;
_LoadConfig_USB_Radon_Tiny:
 LoadConfig_USB_Radon_Tiny:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_USB_Radon_Tiny_Bank0
    mov     X, <LoadConfigTBL_USB_Radon_Tiny_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_USB_Radon_Tiny_Bank1
    mov     X, <LoadConfigTBL_USB_Radon_Tiny_Bank1
