...
export LoadConfigTBL_USB_Radon_Tiny_Bank1
export LoadConfigTBL_USB_Radon_Tiny_Bank0
export LoadConfigTBL_USB_Radon_Tiny_Ordered
AREA lit(rom, rel)
LoadConfigTBL_USB_Radon_Tiny_Bank0:
...
;       Instance name Counter8_1, Block Name CNTR8(DBB00)
	...
	db		21h, 67h		;Counter8_1_PERIOD_REG(DBB00DR1)
	db		22h, 34h		;Counter8_1_COMPARE_REG(DBB00DR2)
...
;  Global Register values Bank 0
	...
	db		b1h, 08h		; Row_0_InputSync register (RDI0SYN)
	...
	db		ffh
LoadConfigTBL_USB_Radon_Tiny_Bank1:
;  Instance name Counter8_1, User Module Counter8
;       Instance name Counter8_1, Block Name CNTR8(DBB00)
	db		20h, 61h		;Counter8_1_FUNC_REG(DBB00FN)
	db		21h, 14h		;Counter8_1_INPUT_REG(DBB00IN)
	db		22h, 00h		;Counter8_1_OUTPUT_REG(DBB00OU)
;  Instance name LED_1, User Module LED
;  Instance name SleepTimer_1, User Module SleepTimer
;  Instance name UART_1, User Module UART
;       Instance name UART_1, Block Name RX(DCB03)
	db		2ch, 05h		;UART_1_RX_FUNC_REG   (DCB03FN)
	db		2dh, f2h		;UART_1_RX_INPUT_REG  (DCB03IN)
...
LoadConfigTBL_USB_Radon_Tiny_Ordered:
;  Ordered Global Register values
	...
	mov	reg[05h], d7h		; Port_1_DriveMode_1 register (PRT1DM1)
	M8C_SetBank0
	mov	reg[07h], 57h		; Port_1_DriveMode_2 register (PRT1DM2)
	mov	reg[06h], a0h		; Port_1_GlobalSelect register (PRT1GS)
	M8C_SetBank1
